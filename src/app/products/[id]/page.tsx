...
import { Check, ChevronRight, Minus, ShieldCheck, Truck } from "lucide-react"
  ...
  return (
    <main className="min-h-screen bg-[#fbfbfa] text-slate-950">
      <div className="mx-auto max-w-7xl px-6 py-10 sm:py-14">
        <nav className="mb-10 flex flex-wrap items-center gap-1.5 text-sm text-slate-500">
          <Link href="/" className="transition-colors hover:text-slate-950">
            Home
          </Link>
          <ChevronRight className="size-3.5" />
          <Link href="/products" className="transition-colors hover:text-slate-950">
            Products
          </Link>
          <ChevronRight className="size-3.5" />
        ...
        <div className="grid grid-cols-1 items-start gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="lg:sticky lg:top-24">
            <div className="overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-[0_8px_30px_rgba(15,23,42,0.04)]">
              <div className="relative aspect-square bg-[#f4f4f2] p-6 sm:p-10">
